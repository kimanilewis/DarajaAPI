...
namespace  daraja\DarajaAPI\Controllers;

use daraja\DarajaAPI\Utilities\SyncLogger as logger;
use  daraja\DarajaAPI\Utilities\Encryption;
use  daraja\DarajaAPI\Config\Config;
use  daraja\DarajaAPI\Config\StatusCodes as StatusCodes;
use  daraja\DarajaAPI\Utilities\Authenticator as Authenticator;
use Exception;
    ...
    public function route($request) {
        ...
        switch (strtolower($request['route'])) {
            ...
            case 'pos':
                ...
                break;
            case 'payment':
                $SyncRequest = new PaymentController();
                $result = $SyncRequest->processPaymentRequest($requestData);
                break;
            case 'mpesa_request':
