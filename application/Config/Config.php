...
class Config {
    ...
    const error = '/var/log/applications/daraja/error.log';
    const info = '/var/log/applications/daraja/info.log';
    const debug = '/var/log/applications/daraja/debug.log';
    const tat = '/var/log/applications/daraja/tat.log';
    const sequel = '/var/log/applications/daraja/sql.log';
    ...
    const EXPIRED_ACCOUNT = "Dear CUSTOMERNAME, Your card number ACCOUNTNUMBER has been expired. You will receive a request from mpesa to authorise payment. Thank you for choosing #Tap&Charge.";
